...
?>
	...
	<div class="bg">
		...
		<div class="gallery">
			<div class="leftimg">
				<img class="img-gallery" src="<?php echo get_theme_mod( 'firts_iamge', get_bloginfo( 'template_directory' ) . '/assets/images/Rectangle1.png' ); ?>" border="0" alt="map">
			</div>
				
			<div class="centerimg">
				<img class="img-gallery" src="<?php echo get_theme_mod( 'second_image', get_bloginfo( 'template_directory' ) . '/assets/images/Rectangle2.png' ); ?>" border="0" alt="">
			</div>
			
			<div class="rightimg">
				<img class="img-gallery" src="<?php echo get_theme_mod( 'third_image', get_bloginfo( 'template_directory' ) . '/assets/images/Rectangle3.png' ); ?>" border="0" alt="">
			</div>
		</div>
				...
				<div class="col2mob">
					<span>
						...
						printf(
							get_theme_mod(
								'latest_sale',
								__( 'Backyard Sale 12-15-2021<br>Easter Egg Hunt 04-23-2021<br>Coffee Hours 02-08-2021<br>Backyard Together 11-16-2021<br>Pet Celebration 07-10-2021', 'latest_sale' )
							)
						);
						?>
					</span>
		...
		<div class="copyright">
			...
			<h1>
				<?php printf( get_theme_mod( 'Footer_text', __( 'Blue Lake Homes', 'Footer_text' ) ) ); ?>
			</h1>
