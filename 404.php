<?php
get_header(); ?>
  <div class="site-content-404" style="background-image:url('<?php echo get_theme_mod('Background_image',get_bloginfo('template_directory').'/assets/images/banner.png' ); ?>')">
